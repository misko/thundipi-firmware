...
{
0x4c, 0xf2, 0x22, 0x4b, 0xad, 0xaf, 0x31, 0xb7, 0x94, 0x2f, 0xd8, 0xa2, 0xa5, 0xaf, 0x93, 0x77, 
0xb0, 0xac, 0x63, 0xe5, 0xb9, 0x32, 0xdb, 0x6a, 0x97, 0x83, 0xc5, 0xa5, 0x1f, 0xcb, 0x81, 0x87, 
0xb8, 0x56, 0xfb, 0x5e, 0x52, 0x23, 0x51, 0xe9, 0x9c, 0x42, 0xf8, 0xe4, 0xb7, 0x24, 0x04, 0x15, 
0x12, 0x09, 0xf4, 0xb9, 0x67, 0xb4, 0x7d, 0xc6, 0x48, 0x5f, 0x20, 0xf5, 0xad, 0xb5, 0xdb, 0xe6, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_35 ) = {
	.len=19,
	.data={0x12,0x25,0x00,0x12,0x09,0xf4,0xb9,0x67,0xb4,0x7d,0xc6,0x48,0x5f,0x20,0xf5,0xad,0xb5,0xdb,0xe6,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_32 ) = {
	.len=19,
	.data={0x12,0x22,0x00,0xb8,0x56,0xfb,0x5e,0x52,0x23,0x51,0xe9,0x9c,0x42,0xf8,0xe4,0xb7,0x24,0x04,0x15,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_29 ) = {
	.len=19,
	.data={0x12,0x1f,0x00,0xb0,0xac,0x63,0xe5,0xb9,0x32,0xdb,0x6a,0x97,0x83,0xc5,0xa5,0x1f,0xcb,0x81,0x87,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_15 ) = {
	.len=19,
	.data={0x02,0x11,0x00,0x4c,0xf2,0x22,0x4b,0xad,0xaf,0x31,0xb7,0x94,0x2f,0xd8,0xa2,0xa5,0xaf,0x93,0x77,}
};
uint8_t bg_gattdb_data_attribute_field_14_data[2]={0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8000,.permissions=0x841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_16},
    ...
    {.uuid=0x0008,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_19},
    ...
    {.uuid=0x000b,.permissions=0xc43,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_24},
    {.uuid=0x0011,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x07,.clientconfig_index=0x01}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_26},
    {.uuid=0x000c,.permissions=0x2841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_27},
    {.uuid=0x0011,.permissions=0xa07,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x08,.clientconfig_index=0x02}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_29},
    {.uuid=0x8001,.permissions=0x4841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_30},
    {.uuid=0x0011,.permissions=0xc07,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x09,.clientconfig_index=0x03}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_32},
    {.uuid=0x8002,.permissions=0x4841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_33},
    {.uuid=0x0011,.permissions=0xc07,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x0a,.clientconfig_index=0x04}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_35},
    {.uuid=0x8003,.permissions=0x4841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_36},
    {.uuid=0x0011,.permissions=0xc07,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x0b,.clientconfig_index=0x05}},
    ...
    {.uuid=0x8005,.permissions=0x802,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_40},
};
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid16_map[])={0x00,0x18,0x0a,0x18,0x15,0x18,};
