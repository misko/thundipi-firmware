...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000b,.permissions=0x2841,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x0010,.permissions=0xa07,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x06,.clientconfig_index=0x02}},
